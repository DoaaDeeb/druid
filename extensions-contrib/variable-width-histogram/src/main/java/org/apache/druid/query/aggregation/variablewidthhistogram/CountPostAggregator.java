 ...
 */
 ...
 @JsonTypeName("count")
 public class CountPostAggregator extends VariableWidthHistogramPostAggregator
 {

    // Cache type ID - temporary until contributed upstream to AggregatorUtil
    private static final byte VARIABLE_WIDTH_HIST_COUNT = 53;
   ...
   public Object compute(Map<String, Object> values)
   {
     ...
     if (val instanceof VariableWidthHistogram) {
       final VariableWidthHistogram ah = (VariableWidthHistogram) val;
       return ah.getCount();
     }
   ...
   {
     return new CacheKeyBuilder(VARIABLE_WIDTH_HIST_COUNT)
